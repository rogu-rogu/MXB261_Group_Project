...
xlabel("alpha"), ylabel("beta"), zlabel("rho")
lgd = legend("LHS successful samples", "Orthogonal successful samples", ...
    "Failed samples " + newline +...
    "(darker colour" + newline + "corresponds to" + newline +...
    "greater proportion" + newline + "of successful trials)");
%----Positioning------------%
lgd.Location = "eastoutside";
...
xlabel("alpha"), ylabel("beta"), zlabel("rho")
lgd = legend("Box containing" + newline + "successful samples", ...
    "Box containing" + newline + "samples with at" + newline + ...
